      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 rounded-2xl bg-[#090C16] border border-white/[0.1] shadow-xl">
        <div>
          <div className="flex items-center space-x-2 text-xs font-mono text-cyan-400 mb-1">
            ...
            <span>Strands Agents Multi-Agent Transparency Protocol</span>
          </div>
          <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight">
            Live Multi-Agent Telemetry & Audit Stream
          </h2>
          <p className="text-xs sm:text-sm text-zinc-400 max-w-2xl mt-1 leading-relaxed">
            Inspect the step-by-step reasoning pipeline. Watch how Orchestrator delegates tasks to Profile, Scheme, Eligibility (Corretto), Evidence, and Recommendation agents under Cedar policy boundaries.
          </p>
        </div>
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="flex items-center space-x-1.5 px-3.5 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-mono font-medium transition-colors shadow-glow-sm"
          >
